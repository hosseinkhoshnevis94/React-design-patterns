...
import "./styles.css";
//We have a List component and we want to use showing any kind of datas.in this case
//we only can use it for product items because the products and companies each one has their own property values.
